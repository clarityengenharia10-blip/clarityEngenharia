    ...
    <div className="flex flex-col min-h-screen font-sans">
      ...
      <div className="bg-[#002b5c] text-white text-xs py-2 px-4 md:px-10 hidden lg:flex justify-between items-center">
        ...
        <div className="flex gap-4 items-center">
          {/* Facebook */}
          <a href="#" className="text-white hover:text-sky-400 transition-colors" aria-label="Facebook">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
          </a>
          {/* Instagram */}
          <a href="#" className="text-white hover:text-sky-400 transition-colors" aria-label="Instagram">
          ...
          {/* LinkedIn */}
          <a href="#" className="text-white hover:text-sky-400 transition-colors" aria-label="LinkedIn">
