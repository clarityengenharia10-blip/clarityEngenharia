        ...
        <div className="flex flex-col gap-10">
          <div className="bg-primary/5 dark:bg-primary/10 rounded-2xl p-6 md:p-8 border border-primary/10">
            ...
            <div className="flex flex-col gap-8">
              {[
                { icon: 'location_on', title: 'Sede Administrativa', content: 'Av. Paulista, 1000 - São Paulo, Brasil' },
                { icon: 'call', title: 'Telefones Diretos', content: '+55 (11) 4002-8922 (Geral)\n+55 (11) 4002-8923 (Engenharia)' },
          ...
          <div className="relative h-[300px] md:h-[400px] w-full rounded-2xl overflow-hidden border border-slate-200 dark:border-white/10 group">
             <img src={IMAGES.map} alt="Localização" className="w-full h-full object-cover grayscale opacity-50 transition-all duration-700 group-hover:grayscale-0 group-hover:opacity-100" />
             <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <div className="bg-primary p-3 rounded-full shadow-2xl animate-pulse">
                  <span className="material-symbols-outlined text-white text-3xl fill-icon">location_on</span>
                </div>
                <div className="bg-white dark:bg-slate-900 px-4 py-2 rounded-lg shadow-2xl border border-primary/20 mt-3">
                  <p className="text-xs md:text-sm font-black text-slate-900 dark:text-white">Matriz Clarity Engenharia</p>
                </div>
             </div>
          </div>
        </div>
